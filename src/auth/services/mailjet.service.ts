...
export class MailjetService {
  ...
  constructor(private readonly configService: ConfigService) {
    this.mailjet = new Client({
      apiKey: this.configService.get<string>('MAILJET_PUBLIC_KEY'),
      ...
      Messages: [
        {
          ...
          Please copy this URL into your browser, to reset your password:
          ${this.configService.get('RESET_PASSWORD_URL')}/${token}
          `,
          HTMLPart: `
                                                    ...
                                                    <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                      ...
                                                      <div class="space-y-3">
                                                        <div class="space-y-3">
                                                          ...
                                                          <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">
                                                            Protecting your data is important to us. Please click on the button below to begin.
                                                          </p>
                                                        </div>
                                                      </div>
          ...
          `,
          // TemplateID: this.configService.get<number>('RESET-PASSWORD-TEMPLATE-ID'),,
      ...
      Messages: [
        {
          ...
          TextPart: `
          Hi ${username}!
          We need to validate your email address to fully activate your HiSudoku account. 
          Simply copy this URL into your browser:
          ${this.configService.get<string>('ACTIVATE_EMAIL_URL')}/${token}`,
                                                  ...
                                                  <tr>
                                                    <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                      ...
                                                      <div class="space-y-3">
                                                        <div class="space-y-3">
                                                          <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">
                                                            We need to validate your email address to fully activate your account. 
                                                      ...
                                                      <div class="space-y-3">
                                                        If the link doesn&#8217;t work, copy this URL into your browser: ${this.configService.get(
                                                          'ACTIVATE_EMAIL_URL',
                                                        )}/${token}, 
                                                      </div>
                                                    </td>
